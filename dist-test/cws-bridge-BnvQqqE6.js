import { a as e, i as t, r as n } from "./src-CJkOASls.js";
import { t as r } from "./UniformInterop-C0jUw_HW.js";
...
var S = class extends u {
	...
	async invoke(e) {
		let t = T(e.channel, e.payload, e.envelope);
		return {
			ok: !0,
			channel: e.channel,
			echo: { ...e.payload ?? {} },
...
}, C = l("CwsBridge", { web: () => new S() }), w = !1, T = (i, a, o) => o && t(o) ? e(o) : n({
	...r({
		purpose: "invoke",
		protocol: "service",
	...
	path: ["cws-bridge", i]
}), E = (i, a, o) => o?.envelope && t(o.envelope) ? e(o.envelope) : n({
	...r({
		purpose: "invoke",
		protocol: "service",
		transport: "service-worker",
...
async function D() {
	if (w) return globalThis.window === void 0 ? null : globalThis.window.__CWS_SHELL_INFO__ ?? null;
	w = !0;
	let i = globalThis.window?.electronBridge?.getShellInfo;
	if (typeof i == "function") try {
		let e = await i();
		return globalThis.window !== void 0 && (globalThis.window.__CWS_SHELL_INFO__ = e), e;
	} catch {}
	try {
		let i = await C.getShellInfo();
		globalThis.window !== void 0 && (globalThis.window.__CWS_SHELL_INFO__ = i);
		try {
			await C.addListener("nativeMessage", (i) => {
				let a = i && typeof i.payload == "object" && i.payload != null ? i.payload : {}, o = a?.envelope, s = o && typeof o == "object" && t(o) ? e(o) : n(r({
					purpose: "mail",
					protocol: "service",
					transport: "service-worker",
					type: "act",
...
async function j(e) {
	let t = (e.channel || "").trim() || (Array.isArray(e.envelope?.path) && e.envelope?.path.length ? String(e.envelope.path[e.envelope.path.length - 1] || "").trim() : "") || "default", n = e.payload && typeof e.payload == "object" ? e.payload : {}, r = T(t, n, e.envelope), i = globalThis.window?.electronBridge?.invoke;
...
async function M() {
	try {
		let e = await j({ channel: "settings:get" });
...
//#endregion
export { M as getNativeUnifiedSettings, D as initCwsNativeBridge, O as isCapacitorCwsNativeShell, A as isCwsNativeIpcAvailable, N as patchNativeUnifiedSettings };
