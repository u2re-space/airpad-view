import { c as e, d as t, u as n } from "./UniformInterop-DxjJGqmH.js";
import { c as r, o as i, t as a } from "./messaging-DTqWl-L-.js";
import { r as o, t as s } from "./channel-mixin-Bfoy3DA8.js";
...
var j = new class {
	...
	async load(e, t) {
		...
		let o = A(await a(t)), s = this.viewReceiveCleanup.get(e);
...
function P() {
	M.register({
		...
		name: "Viewer",
		icon: "eye",
		loader: () => import("./src-BBf6d1I9.js")
	}), M.register({
		id: "workcenter",
		name: "Work Center",
		icon: "lightning",
		loader: () => import("./src-BUiDoFL9.js")
	}), M.register({
		id: "settings",
		name: "Settings",
		icon: "gear",
		loader: () => import("./src-wQvJdUxF.js")
	}), M.register({
		id: "airpad",
		name: "AirPad",
		icon: "hand-pointing",
		loader: () => import("./src-BLeKz4Uk.js").then((e) => e.t)
	}), M.register({
		id: "network",
		name: "Network",
		icon: "wifi-high",
		loader: () => import("./src-CUEatB53.js")
	}), M.register({
		id: "history",
		name: "History",
		icon: "clock-counter-clockwise",
		loader: () => import("./src-DGcQdjgR.js")
	}), M.register({
		id: "explorer",
		name: "Explorer",
		icon: "folder",
		loader: () => import("./src-iSYq9_Ky.js")
	}), M.register({
		id: "editor",
		name: "Editor",
		icon: "pencil",
		loader: () => import("./src-DI0O6364.js")
	}), M.register({
		id: "home",
		name: "Home",
		icon: "house",
		loader: () => import("./src-BkmIrHjo.js")
	}), M.register({
		id: "print",
		name: "Print",
		icon: "printer",
...
//#endregion
export { R as a, c, F as i, d as l, M as n, I as o, L as r, k as s, j as t };
