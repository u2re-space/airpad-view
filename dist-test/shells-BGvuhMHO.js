import { Sr as e, W as t, or as n, xr as r } from "./src-C-qx_Mx3.js";
import { h as i, p as a } from "./Settings-BAxgoWK0.js";
import { n as o } from "./toast-B6k6nwY1.js";
import { t as s } from "./src-Be-NRxK4.js";
import { i as c, o as l, t as u } from "./Theme-CdcoWri7.js";
import "./theme-DbFndQdi.js";
import { l as d, n as f } from "./registry-DLZ4JdC3.js";
import { i as p } from "./channel-mixin-Bfoy3DA8.js";
import { f as m, t as h } from "./views-AD17wavT.js";
import { n as g } from "./shell-slots-Cg4mOSVd.js";
...
var _ = [
	...
	"settings",
	"print"
], v = () => typeof document < "u" && "startViewTransition" in document;
function y(e, t) {
...
function w(e) {
	let t = `cw-shell-${e}`;
	return customElements.get(t) || customElements.define(t, C), t;
}
//#endregion
...
var T = new Set([
	...
	async mount(n) {
		...
		let a = w(this.id), o = document.createElement(a), c = this.createLayout();
	...
	syncNavigationFromUrl() {
		...
		let e = globalThis?.history?.state?.viewId, t = this.getViewFromPathname(), n = e && m(String(e)) ? e : t && m(String(t)) ? t : null;
	...
	async navigate(e, t, n) {
		...
		try {
			...
			S(e), this.hideShellLoadingPlaceholder();
		} catch (t) {
	...
	getContext() {
		...
		return {
			...
			resolveOverlayMountPoint: (e) => this.overlayContainer || g(e ?? null)
		};
	}
	getElement() {
	...
	async renderViewWithTransition(e) {
		...
		let t = this.navigationState.previousView, n = t && t !== this.currentView.value ? this.loadedViews.get(t) : void 0, r = y(t ?? "", this.currentView.value);
		await b(() => this.renderView(e), {
			direction: r,
		...
		typeof window > "u" || typeof window > "u" || globalThis?.addEventListener?.("popstate", (e) => {
			...
			if (r !== this.currentView.value || !this.sameRouteParams(i, this.navigationState.params)) {
				...
				a >= 0 ? this.navigationState.viewHistory = n.slice(0, a + 1) : this.navigationState.viewHistory = [r], this.loadView(r, i).then((e) => {
					...
					t === this.navigationToken && (S(r), this.hideShellLoadingPlaceholder());
				}).catch(console.error);
			}
		});
	}
