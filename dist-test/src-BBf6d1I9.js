import { A as e, Cr as t, M as n, Ut as r, a as i, br as a, i as o, o as s, or as c, r as l, tr as u } from "./src-C-qx_Mx3.js";
import { t as d } from "./registry-CiE_ry8S.js";
import { p as f } from "./Settings-BAxgoWK0.js";
import { n as p, o as m } from "./channel-actions-k77dxast.js";
import { n as h } from "./types-ZxtDAQ5P.js";
import { n as g, t as _ } from "./src-Be-NRxK4.js";
import { n as v } from "./channel-mixin-Bfoy3DA8.js";
import { i as y, n as b, t as x } from "./view-ingress-validation-BAZBcRCE.js";
import { t as S } from "./view-transport-eOhxm3Xm.js";
import { t as C } from "./purify.es-5RSwiq1o.js";
import { t as w } from "./auto-render-DwKnRJZy.js";
...
var J = async () => A || (A = (async () => {
	let [{ marked: e }, { default: t }] = await Promise.all([import("./marked.esm-g7usi8Kp.js").then((e) => e.n), import("./src-VHum8UhF.js").then((e) => e.n)]);
	return e?.use?.(t({
		throwOnError: !1,
		nonStandard: !0,
		output: "mathml",
...
var X = "rs-viewer-state", Z = "# This is content", Q = "cw-view-viewer", $ = d(Q, (d) => class extends d {
	...
	async handleExportDocx() {
		...
		try {
			let { downloadMarkdownAsDocx: t } = await import("./docx-export-DhaQZRlp.js");
			await t(e, {
	...
	async navigateSingletonShell(e) {
		try {
			let { bootLoader: t } = await import("./BootLoader-ow_gF8Le.js"), n = t.getShell();
			if (n?.navigate && ![
				"window",
				"tabbed",
				"environment"
	...
	async invokeChannelApi(e, t) {
		...
		switch (e) {
			...
			case m.AttachToWorkcenter: return this.attachCurrentContentToWorkcenter().then(() => void 0);
			case m.OpenUrl:
			case m.OpenMarkdownUrl: {
				let e = String(n.url || "");
	...
	async handleMessage(e) {
		let t = e;
		if (t.type === m.SetColorScheme || t.type === p.SetColorScheme) {
