import { Cr as e, Lt as t, Rt as n, Sr as r, Ut as i, Vt as a, a as o, br as s, i as c, o as l, xr as u } from "./src-C-qx_Mx3.js";
import { o as d } from "./UniformInterop-DxjJGqmH.js";
import { i as f, r as p, s as m } from "./messaging-DTqWl-L-.js";
import { t as h } from "./log-sanitizer--qMKW3ZD.js";
import { t as ee } from "./src-Be-NRxK4.js";
import { i as g } from "./view-ingress-validation-BAZBcRCE.js";
import { t as _ } from "./decorate-nwY9Is7M.js";
import { t as v } from "./auto-render-DwKnRJZy.js";
import { a as y, i as b, o as x } from "./custom-instructions-DFS-KejK.js";
import { t as S } from "./marked.esm-g7usi8Kp.js";
import { t as te } from "./src-VHum8UhF.js";
import { t as ne } from "./WorkCenterState-4bcQPF0z.js";
import { t as re } from "./WorkCenterDataProcessing-DJCx_Vw9.js";
...
var se = class {
	...
	async addShareTargetResult(e, t) {
		...
		}, { WorkCenterStateManager: r } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
	...
	async addShareTargetInput(e, t) {
		...
		try {
			...
			let { WorkCenterStateManager: d } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
	...
	async handleAIResult(e, t) {
		...
		try {
			...
			}, { WorkCenterStateManager: n } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
...
var le = class {
	...
	async getDefaultTemplates() {
		let { DEFAULT_INSTRUCTION_TEMPLATES: e } = await import("./instruction-templates-C7Si04Df.js").then((e) => e.n);
		return e;
	}
	...
	async saveTemplates(e, t) {
		...
		let { WorkCenterStateManager: i } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
	...
	async executeUnifiedAction(e) {
		...
		try {
			...
			}), { WorkCenterStateManager: o } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
	...
	async viewResultsInViewer(e) {
		...
		try {
			let { unifiedMessaging: t } = await import("./messaging-COfbPN8X.js"), n = typeof e.lastRawResult == "string" ? e.lastRawResult : JSON.stringify(e.lastRawResult, null, 2);
			try {
	...
	setupTemplateSelection() {
		...
		e?.addEventListener("change", async () => {
			...
			let { WorkCenterStateManager: n } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
	...
	setupInstructionSelection() {
		...
		this.prompts.populateInstructionSelect(this.state).then(async () => {
			let { WorkCenterStateManager: e } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
	...
	setupPromptInput() {
		...
		e && e.addEventListener("input", async () => {
			...
			let { WorkCenterStateManager: t } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
	...
	setupFormatSelectors() {
		...
		e.addEventListener("change", async () => {
			...
			if (n.saveState(this.state), this.state.lastRawResult) {
				let e = this.container?.querySelector("[data-output]"), { WorkCenterDataProcessing: n } = await import("./WorkCenterDataProcessing-DJCx_Vw9.js").then((e) => e.n);
		...
		this.container && this.container.addEventListener("click", async (e) => {
			...
			if (n) switch (n) {
				...
				case "clear-recognized":
					...
					break;
				case "clear-pipeline":
					let { WorkCenterStateManager: r } = await import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n);
		...
		this.container && this.container.addEventListener("click", async (e) => {
			...
			if (t !== null) {
				...
				if (this.state.processedData && this.state.processedData[e]) {
					let t = this.state.processedData[e], n = this.container?.querySelector("[data-output]"), { WorkCenterDataProcessing: r } = await import("./WorkCenterDataProcessing-DJCx_Vw9.js").then((e) => e.n);
	...
	switchInputTab(e) {
		...
		import("./WorkCenterState-4bcQPF0z.js").then((e) => e.n).then(({ WorkCenterStateManager: e }) => e.saveState(this.state)).catch(() => {});
	}
	switchResultsTab(e) {
		if (!this.container || ![
			"output",
...
var W = null;
async function me() {
	return W || (W = import("./font-registry-BISN8C7m.js")?.catch?.((e) => {
