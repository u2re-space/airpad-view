import { A as e, Ar as t, C as n, Cr as r, E as i, Lt as a, M as o, N as s, P as c, R as l, Rt as u, Sr as d, Ut as f, Vt as p, ar as ee, b as te, br as ne, gt as re, h as m, hn as ie, ir as h, jr as g, or as _, tr as v, vr as ae, x as y, y as b, z as oe } from "./src-C-qx_Mx3.js";
import { t as se } from "./src-CFwTR5EZ.js";
import { t as ce } from "./registry-CiE_ry8S.js";
import { n as x } from "./channel-actions-k77dxast.js";
import { t as le } from "./src-Be-NRxK4.js";
import { a as ue, i as de, o as fe, r as pe, s as me, t as he } from "./state-storage-BJnUdhO3.js";
import { a as S, r as ge, t as C } from "./storage-lN1pTVHb.js";
import { n as _e, r as ve } from "./ContextMenu-B7lllIkC.js";
import { t as w } from "./view-transport-eOhxm3Xm.js";
import { t as T } from "./decorate-nwY9Is7M.js";
...
var be = (e, t, n, r) => {
	...
	return !t || t.startsWith("text/") || t.includes("markdown") || t.includes("json") || t.includes("xml") ? !0 : xe.has(Ce(e.name || ""));
}, j = (e) => {
	let t = Math.random().toString(36).slice(2, 8), n = Date.now().toString(36);
	return `viewer-${String(e || "viewer").replace(/[^a-z0-9_-]/gi, "-").slice(0, 18) || "viewer"}-${n}-${t}`;
}, we = () => {
	let e = new Set(Array.from(me ?? []).map((e) => `${Math.round(e?.cell?.[0] || 0)}:${Math.round(e?.cell?.[1] || 0)}`));
...
function Te(e, t) {
	...
	let n = String(ge(C.EXPLORER_PATH, "/user/") || "").trim();
	e.path = !n || n === "/" ? "/user/" : n;
}
function Ee(e, t, n, r) {
	let i = { signal: r }, a = (e) => t.shellContext?.showMessage?.(e), o = async (e, t, n = "window") => {
		...
		if (!r || !A(r)) return !1;
		let i = String(t || "");
		if (n === "base" || n === "immersive") return k({
			viewId: "viewer",
			target: "immersive",
			params: {
				src: i,
		...
		let i = `${e?.path || "/"}${r}`, o = pe(h(we()));
		o.label.value = r, o.icon.value = t?.kind === "directory" ? "folder" : "file-text", o.action = "open-link", he(o);
		let s = de(o.id, { action: "open-link" });
		s.action = "open-link", s.href = i, s.description = `Pinned from Explorer: ${i}`, ue(), fe(), a(`Pinned ${r} to Home`);
	}, l = (t) => `${e?.path || "/"}${t?.name || ""}`, u = {
		view: async (e) => {
		...
		t?.kind !== "file" || !t?.file || await o(t, n, "window") || k({
			viewId: "workcenter",
			target: "window"
		});
	};
...
function De(e, t, n) {
	...
	c.type = "file", c.multiple = !0, c.accept = ".md,.markdown,.txt,.json,.xml,.yaml,.yml,.csv,.log,text/*", c.style.display = "none", e.append(c), o.addEventListener("click", () => c.click(), r), s?.addEventListener("click", () => k({
		viewId: "workcenter",
		target: "window"
...
function M(e, t) {
	let n = E(O(), t.inject), r = new AbortController(), { signal: i } = r, a = e.querySelector("ui-file-manager");
	return n?.onWire?.(a, e), a ? (Te(a, t.initialPath ?? null), Ee(a, t, n, i), {
		cleanup: () => {
			S(C.EXPLORER_PATH, a.path || "/user/"), r.abort();
		},
		fileManager: a
	}) : (De(e, t, i), {
		cleanup: () => r.abort(),
...
function P(e) {
	return e === "light" || e === "dark" ? e : N() || (typeof globalThis.matchMedia == "function" && globalThis.matchMedia("(prefers-color-scheme: light)").matches ? "light" : "dark");
}
function F(e, t) {
	if (!e) return;
	let n = P(t ?? void 0);
...
function I(e, t) {
	...
	let r = () => {
		e.isConnected && (t() ?? "system") === "system" && F(e, "system");
	};
...
var Oe = "@charset \"UTF-8\";\n/* ai-refactor: optimized/refactored at 2026-02-13T00:45:15Z */\n/* ai-refactor: optimized/refactored at 2026-02-13T00:45:12Z */\n@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;\n@layer components {\n  button,\n  .btn {\n    display: inline-flex;\n    align-items: center;\n    justify-content: center;\n    gap: var(--space-sm);\n    padding-block: 0px;\n    padding-inline: 0px;\n    font-size: var(--font-size-sm);\n    font-weight: 500;\n    border-radius: var(--radius-md);\n    background: var(--color-bg-alt);\n    color: var(--color-fg);\n    border: 1px solid var(--color-border);\n    cursor: pointer;\n    transition: all var(--transition-fast);\n  }\n  button:hover:not(:disabled),\n  .btn:hover:not(:disabled) {\n    background: var(--color-border);\n  }\n  button:focus-visible,\n  .btn:focus-visible {\n    outline: 2px solid var(--color-primary);\n    outline-offset: 2px;\n  }\n  button:disabled,\n  .btn:disabled {\n    opacity: 0.5;\n    cursor: not-allowed;\n  }\n  .btn {\n    --ui-bg: var(--color-surface-container-high);\n    --ui-fg: var(--color-on-surface);\n    --ui-bg-hover: var(--color-surface-container-highest);\n    --ui-ring: var(--color-primary);\n    --ui-radius: var(--radius-lg);\n    --ui-pad-y: var(--space-sm);\n    --ui-pad-x: var(--space-lg);\n    --ui-font-size: var(--text-sm);\n    --ui-font-weight: var(--font-weight-semibold);\n    --ui-min-h: 40px;\n    --ui-opacity: 1;\n    appearance: none;\n    border: none;\n    background: var(--ui-bg);\n    color: var(--ui-fg);\n    border-radius: var(--ui-radius);\n    padding: max(var(--ui-pad-y, 0px), 0px) max(var(--ui-pad-x, 0px), 0px);\n    font-size: var(--ui-font-size);\n    font-weight: var(--ui-font-weight);\n    letter-spacing: 0.01em;\n    line-height: 1.2;\n    block-size: calc-size(fit-content, max(var(--ui-min-h), size));\n    transition: background-color var(--motion-fast), box-shadow var(--motion-fast), transform var(--motion-fast);\n    box-shadow: var(--elev-0);\n    user-select: none;\n    touch-action: manipulation;\n    pointer-events: auto;\n    gap: var(--space-xs);\n    text-transform: none;\n    opacity: var(--ui-opacity);\n    min-block-size: fit-content;\n    min-inline-size: calc-size(fit-content, size + 0.5rem + var(--icon-size, 1rem));\n    max-inline-size: none;\n    max-block-size: stretch;\n    flex-direction: row;\n    flex-wrap: nowrap;\n    text-wrap: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    white-space: nowrap;\n    text-align: center;\n    text-decoration: none;\n    text-shadow: none;\n    text-rendering: auto;\n    contain: none;\n    container-type: normal;\n    place-items: center;\n    place-content: center;\n    justify-content: safe center;\n    justify-items: safe center;\n    align-content: safe center;\n    align-items: safe center;\n  }\n  .btn > ui-icon {\n    flex-shrink: 0;\n    pointer-events: none;\n    color: inherit;\n    align-self: center;\n    vertical-align: middle;\n  }\n  @media (max-width: 480px) {\n    .btn.btn-icon {\n      font-size: 0px !important;\n      aspect-ratio: 1/1;\n      block-size: fit-content;\n      max-block-size: stretch;\n      min-inline-size: 0px;\n      max-inline-size: fit-content;\n      gap: 0px;\n    }\n    .btn.btn-icon .btn-text,\n    .btn.btn-icon span:not(.sr-only) {\n      display: none !important;\n    }\n  }\n  .btn:hover {\n    background: var(--ui-bg-hover);\n    box-shadow: var(--elev-1);\n    transform: translateY(-1px);\n  }\n  .btn:active {\n    transform: translateY(0);\n    box-shadow: var(--elev-0);\n  }\n  .btn:focus-visible {\n    outline: none;\n    box-shadow: 0 0 0 3px color-mix(in oklab, var(--ui-ring) 35%, transparent);\n  }\n  .btn:disabled {\n    opacity: 0.5;\n    cursor: not-allowed;\n    transform: none !important;\n  }\n  .btn:disabled:hover {\n    background: var(--color-surface-container-high);\n    box-shadow: var(--elev-0);\n  }\n  .btn.primary, .btn.active {\n    --ui-bg: var(--color-primary);\n    --ui-fg: var(--color-on-primary);\n    --ui-ring: var(--color-primary);\n  }\n  .btn.primary {\n    --ui-bg-hover: color-mix(in oklab, var(--color-primary) 90%, black);\n  }\n  .btn.active {\n    box-shadow: var(--elev-1);\n  }\n  .btn.small {\n    --ui-pad-y: var(--space-xs);\n    --ui-pad-x: var(--space-md);\n    --ui-font-size: var(--text-xs);\n    --ui-min-h: 32px;\n    --ui-radius: var(--radius-md);\n  }\n  .btn.icon-btn {\n    inline-size: 40px;\n    block-size: 40px;\n    --ui-pad-y: 0px;\n    --ui-pad-x: 0px;\n    --ui-radius: 9999px;\n    --ui-font-size: var(--text-lg);\n  }\n  .btn[data-action=open-md], .btn[data-action=export-md], .btn[data-action=export-docx] {\n    --ui-font-size: 12px;\n    --ui-pad-x: 8px;\n    --ui-pad-y: 0px;\n    --ui-min-h: 28px;\n  }\n  .btn:is([data-action=view-markdown-viewer],\n  [data-action=view-markdown-editor],\n  [data-action=view-rich-editor],\n  [data-action=view-settings],\n  [data-action=view-history],\n  [data-action=view-workcenter]) {\n    --ui-font-size: 13px;\n    --ui-font-weight: 500;\n    --ui-pad-x: 12px;\n    --ui-pad-y: 0px;\n    --ui-min-h: 32px;\n    --ui-radius: 16px;\n    text-transform: capitalize;\n  }\n  .btn:is([data-action=view-markdown-viewer],\n  [data-action=view-markdown-editor],\n  [data-action=view-rich-editor],\n  [data-action=view-settings],\n  [data-action=view-history],\n  [data-action=view-workcenter][data-current],\n  [data-action=view-workcenter].active) {\n    --ui-bg: var(--color-surface-container-highest);\n    --ui-fg: var(--color-primary);\n    --ui-ring: var(--color-primary);\n  }\n  .btn:is([data-action=toggle-edit],\n  [data-action=snip],\n  [data-action=solve],\n  [data-action=code],\n  [data-action=css],\n  [data-action=voice],\n  [data-action=edit-templates],\n  [data-action=recognize],\n  [data-action=analyze],\n  [data-action=select-files],\n  [data-action=clear-prompt],\n  [data-action=view-full-history]) {\n    --ui-font-size: 12px;\n    --ui-pad-x: 8px;\n    --ui-pad-y: 0px;\n    --ui-min-h: 28px;\n    --ui-radius: 14px;\n  }\n  .btn:has(> ui-icon):not(:has(> *:not(ui-icon))), .btn:has(> span:only-of-type:empty) {\n    font-size: 0px !important;\n    aspect-ratio: 1/1;\n    block-size: fit-content;\n    max-block-size: stretch;\n    min-inline-size: 0px;\n    max-inline-size: fit-content;\n    gap: 0px;\n    overflow: visible;\n  }\n  .btn:has(> ui-icon):not(:has(> *:not(ui-icon))) span:not(.sr-only), .btn:has(> span:only-of-type:empty) span:not(.sr-only) {\n    display: none !important;\n  }\n  .btn-primary {\n    background: var(--color-primary);\n    color: white;\n    border-color: var(--color-primary);\n  }\n  .btn-primary:hover:not(:disabled) {\n    background: var(--color-primary-hover);\n    border-color: var(--color-primary-hover);\n  }\n  @media (max-inline-size: 768px) {\n    .btn {\n      --ui-pad-y: var(--space-xs);\n      --ui-pad-x: var(--space-md);\n      --ui-font-size: var(--text-xs);\n      --ui-min-h: 36px;\n    }\n  }\n  @media (max-inline-size: 480px) {\n    .btn {\n      --ui-pad-y: var(--space-xs);\n      --ui-pad-x: var(--space-xs);\n      --ui-font-size: var(--text-xs);\n      --ui-min-h: 32px;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis;\n    }\n    .btn.btn-icon {\n      overflow: visible;\n    }\n  }\n  @media (prefers-reduced-motion: reduce) {\n    .btn {\n      transition: none;\n      transform: none !important;\n    }\n    .btn:hover, .btn:active {\n      transform: none !important;\n    }\n  }\n}\n@layer utilities {\n  .round-decor {\n    --background-tone-shift: 0;\n    padding-block: 0.25rem;\n    border-radius: 0.25rem;\n    overflow: hidden;\n  }\n  .round-decor:empty {\n    padding: 0;\n    display: none;\n    pointer-events: none;\n    visibility: collapse;\n  }\n  .time-format {\n    display: inline-flex;\n    flex-direction: row;\n    place-content: center;\n    place-items: center;\n    place-self: center;\n    padding: 0.125rem;\n    font: 500 0.9em \"InterVariable\", \"Inter\", \"Fira Mono\", \"Menlo\", \"Consolas\", monospace;\n    font-optical-sizing: auto;\n    font-variant-numeric: tabular-nums;\n    font-kerning: auto;\n    font-stretch: condensed;\n    font-width: condensed;\n    letter-spacing: -0.05em;\n    text-wrap: nowrap;\n    text-align: center;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n  /*\n   * WHY: Launcher captions (`[data-layer=\"labels\"]`) must not inherit `aspect-ratio: 1/1` on the text span — it squares the pill height to the caption width.\n   */\n  .ui-ws-item:not([data-layer=labels]) span {\n    pointer-events: none;\n    aspect-ratio: 1/1;\n    inline-size: fit-content;\n    block-size: fit-content;\n    display: inline;\n  }\n  .ui-ws-item {\n    cursor: pointer;\n    user-select: none;\n    pointer-events: auto;\n  }\n  .ui-ws-item:active, .ui-ws-item:has(:active) {\n    will-change: inset, translate, transform, opacity, z-index;\n    cursor: grabbing;\n  }\n}\n@layer essentials {\n  @media print {\n    .ctx-menu, .ux-anchor, .component-loading, .component-error {\n      display: none !important;\n      visibility: hidden !important;\n      opacity: 0 !important;\n      pointer-events: none !important;\n      position: absolute !important;\n      inset: 0 !important;\n      z-index: -1 !important;\n      inline-size: 0 !important;\n      block-size: 0 !important;\n      max-inline-size: 0 !important;\n      max-block-size: 0 !important;\n      min-inline-size: 0 !important;\n      min-block-size: 0 !important;\n      margin: 0 !important;\n      padding: 0 !important;\n      border: none !important;\n      overflow: hidden !important;\n    }\n  }\n  @media screen {\n    :root, :host, :scope {\n      --font-family: \"InterVariable\", \"Inter\", \"Helvetica Neue\", \"Helvetica\", \"Calibri\", \"Roboto\", ui-sans-serif, system-ui, -apple-system, Segoe UI, sans-serif;\n    }\n    ui-window-frame,\n    ui-modal,\n    .ui-grid-item {\n      --opacity: 1;\n      --scale: 1;\n      --rotate: 0deg;\n      --translate-x: 0%;\n      --translate-y: 0%;\n      isolation: isolate;\n      content-visibility: auto;\n      transform-origin: 50% 50%;\n      transform-style: flat;\n      transform-box: fill-box;\n      translate: 0% 0% 0%;\n      opacity: var(--opacity, 1);\n      rotate: 0deg;\n      scale: 1;\n    }\n    .ctx-menu {\n      --font-family: \"InterVariable\", \"Inter\", \"Helvetica Neue\", \"Helvetica\", \"Calibri\", \"Roboto\", ui-sans-serif, system-ui, -apple-system, Segoe UI, sans-serif;\n      /*\n       * WHY: Menus are appended to `body` / overlay, outside `.view-explorer`, so app color\n       * tokens are often missing — without fallbacks text can match background (dark on dark).\n       */\n      color-scheme: light dark;\n    }\n    .ctx-menu,\n    .ctx-menu * {\n      visibility: visible;\n      content-visibility: visible;\n    }\n    .ctx-menu {\n      position: fixed;\n      z-index: 99999;\n      inline-size: max-content;\n      min-inline-size: 160px;\n      max-inline-size: min(240px, 100cqi);\n      block-size: fit-content;\n      padding: 0.25rem 0;\n      border: 1px solid var(--color-outline-variant, light-dark(#c9ced8, #474e5e));\n      border-radius: var(--radius-md, 10px);\n      background-color: var(--color-surface, light-dark(#f6f8fc, #1b2029));\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n      font-size: 0.875rem;\n      font-weight: 400;\n      box-shadow: 0 10px 28px light-dark(rgba(15, 23, 42, 0.14), rgba(0, 0, 0, 0.42)), 0 0 0 1px light-dark(rgba(15, 23, 42, 0.08), rgba(255, 255, 255, 0.07));\n      opacity: 1;\n      visibility: visible;\n      pointer-events: auto;\n      transform: scale3d(var(--scale, 1), var(--scale, 1), 1) translate3d(var(--translate-x, 0px), var(--translate-y, 0px), 0px);\n      transition: opacity 0.15s ease-out, visibility 0.15s ease-out, transform 0.15s ease-out;\n      font-family: var(--font-family, 'system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif') !important;\n      text-align: start;\n      display: flex;\n      flex-direction: column;\n      align-items: stretch;\n    }\n    .ctx-menu[data-hidden] {\n      opacity: 0;\n      visibility: hidden;\n      pointer-events: none;\n    }\n    .ctx-menu > * {\n      display: flex;\n      flex-direction: row;\n      align-items: center;\n      justify-content: flex-start;\n      text-align: start;\n      inline-size: stretch;\n      min-block-size: 2rem;\n      gap: 0.5rem;\n      padding: 0.375rem 0.75rem;\n      border: none;\n      border-radius: var(--radius-sm, 8px);\n      outline: none;\n      position: relative;\n      background-color: transparent;\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n      cursor: pointer;\n      text-wrap: nowrap;\n      text-overflow: ellipsis;\n      white-space: nowrap;\n      overflow: hidden;\n      pointer-events: auto;\n      transition: background-color 0.15s ease, color 0.15s ease;\n      font-family: var(--font-family, 'system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif') !important;\n    }\n    .ctx-menu > *:hover {\n      background-color: var(--color-surface-container-high, light-dark(#e8ecf4, #2a3140));\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n    }\n    .ctx-menu > *:active {\n      background-color: var(--color-surface-container-highest, light-dark(#dde3ee, #343b4d));\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n    }\n    .ctx-menu > *:focus-visible {\n      outline: 2px solid var(--color-primary, light-dark(#1d6fd1, #7eb8ff));\n      outline-offset: 1px;\n      background-color: var(--color-surface-container-high, light-dark(#e8ecf4, #2a3140));\n    }\n    .ctx-menu > *:not(.ctx-menu-separator) {\n      gap: 0.5rem;\n    }\n    .ctx-menu > * > * {\n      pointer-events: none;\n    }\n    .ctx-menu > * > span {\n      flex: 1 1 auto;\n      min-inline-size: 0;\n      text-align: start !important;\n      user-select: none;\n      pointer-events: none;\n      font-size: 0.875rem;\n      font-weight: 400;\n      line-height: 1.25;\n      color: inherit;\n    }\n    .ctx-menu > * > ui-icon {\n      --icon-size: 1rem;\n      flex-shrink: 0;\n      inline-size: var(--icon-size);\n      block-size: var(--icon-size);\n      color: var(--color-on-surface-variant, light-dark(#545c6f, #b4bfd4));\n      user-select: none;\n      pointer-events: none;\n    }\n    .ctx-menu > .ctx-menu-separator, .ctx-menu.ctx-menu-separator {\n      min-block-size: auto;\n      block-size: 1px;\n      margin: 0.125rem 0.375rem;\n      padding: 0;\n      background-color: var(--color-outline-variant, light-dark(#c9ced8, #474e5e));\n      opacity: 0.55;\n      pointer-events: none;\n    }\n    .ctx-menu {\n      /*\n       * `.grid-rows` applies subgrid + place(center) to children, which centers\n       * label text per row. Context menus must stay flex rows with start-aligned labels.\n       */\n    }\n    .ctx-menu.grid-rows {\n      display: flex !important;\n      flex-direction: column;\n      align-items: stretch;\n      grid-template-columns: unset !important;\n      grid-auto-rows: unset !important;\n    }\n    .ctx-menu.grid-rows > *:not(.ctx-menu-separator) {\n      display: flex !important;\n      flex-flow: row nowrap !important;\n      align-items: center !important;\n      justify-content: flex-start !important;\n      grid-column: unset !important;\n      grid-row: unset !important;\n      grid-template-columns: unset !important;\n      grid-template-rows: unset !important;\n      place-content: unset !important;\n      place-items: unset !important;\n    }\n    .ux-anchor {\n      --shift-x: var(--client-x, 0px);\n      --shift-y: var(--client-y, 0px);\n      --translate-x: round(nearest, min(0px, calc(100cqi - (100% + var(--shift-x, 0px)))), calc(1px / var(--pixel-ratio, 1))) !important;\n      --translate-y: round(nearest, min(0px, calc(100cqb - (100% + var(--shift-y, 0px)))), calc(1px / var(--pixel-ratio, 1))) !important;\n      inset-inline-start: max(var(--shift-x), 0px);\n      inset-block-start: max(var(--shift-y), var(--status-bar-padding, 0px));\n      inset-inline-end: auto;\n      inset-block-end: auto;\n      direction: ltr;\n      writing-mode: horizontal-tb;\n      translate: 0% 0% 0%;\n      transform: none;\n    }\n    .component-loading,\n    .component-error {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      padding: 2rem;\n      gap: 1rem;\n      color: var(--text-secondary, light-dark(#666, #aaa));\n    }\n    .component-loading .loading-spinner {\n      inline-size: 2rem;\n      block-size: 2rem;\n      border: 2px solid var(--border, light-dark(#ddd, #444));\n      border-block-start: 2px solid var(--primary, light-dark(#007bff, #5fa8ff));\n      border-radius: 50%;\n      animation: spin 1s linear infinite;\n    }\n    .component-error {\n      text-align: center;\n    }\n    .component-error h3 {\n      margin: 0;\n      color: var(--error, light-dark(#dc3545, #ff6b6b));\n    }\n    .component-error p {\n      margin: 0;\n    }\n    ui-icon {\n      display: inline-flex;\n      align-items: center;\n      justify-content: center;\n      inline-size: var(--icon-size, 1.25rem);\n      block-size: var(--icon-size, 1.25rem);\n      min-inline-size: var(--icon-size, 1.25rem);\n      min-block-size: var(--icon-size, 1.25rem);\n      color: currentColor;\n      fill: currentColor;\n      flex-shrink: 0;\n      vertical-align: middle;\n      opacity: 1;\n      visibility: visible;\n      /* When a parent uses font-size: 0 for layout, keep raster/mask math stable */\n      font-size: 1rem;\n    }\n    ui-icon svg,\n    ui-icon img {\n      inline-size: 100%;\n      block-size: 100%;\n      color: inherit;\n      fill: currentColor;\n    }\n    :is(button, .btn) > ui-icon {\n      color: inherit;\n    }\n    .file-picker {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      min-block-size: 300px;\n      padding: 2rem;\n      text-align: center;\n    }\n    .file-picker .file-picker-header {\n      margin-block-end: 2rem;\n    }\n    .file-picker .file-picker-header h2 {\n      margin: 0 0 0.5rem 0;\n      color: var(--color-on-surface);\n      font-size: 1.5rem;\n      font-weight: 600;\n    }\n    .file-picker .file-picker-header p {\n      margin: 0;\n      color: var(--color-on-surface-variant);\n      font-size: 0.9rem;\n    }\n    .file-picker .file-picker-actions {\n      display: flex;\n      flex-wrap: wrap;\n      justify-content: center;\n      gap: 1rem;\n      margin-block-end: 2rem;\n    }\n    .file-picker .file-picker-actions .btn {\n      display: flex;\n      align-items: center;\n      gap: 0.5rem;\n      padding: 0.75rem 1.5rem;\n      border: 1px solid transparent;\n      border-radius: var(--radius-md);\n      font-weight: 500;\n      transition: all 0.2s ease;\n    }\n    .file-picker .file-picker-actions .btn:hover {\n      transform: translateY(-1px);\n      box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n    }\n    .file-picker .file-picker-actions .btn.btn-primary {\n      background: var(--color-primary);\n      color: var(--color-on-primary);\n      border-color: var(--color-primary);\n    }\n    .file-picker .file-picker-actions .btn:not(.btn-primary) {\n      background: var(--color-surface-container);\n      color: var(--color-on-surface);\n      border-color: var(--color-outline-variant);\n    }\n    .file-picker .file-picker-info {\n      max-inline-size: 400px;\n    }\n    .file-picker .file-picker-info p {\n      margin: 0.25rem 0;\n      font-size: 0.85rem;\n      color: var(--color-on-surface-variant);\n    }\n    .file-picker .file-picker-info p strong {\n      color: var(--color-on-surface);\n    }\n  }\n}\n@layer ux-file-manager-content {\n  /* Tighter actions track + explicit parent columns so subgrid rows align with the header */\n  :host(ui-file-manager-content), :host(ui-file-manager-content) :where(*) {\n    overflow: hidden;\n    scrollbar-width: none;\n    scrollbar-color: transparent transparent;\n    scrollbar-gutter: auto;\n  }\n  :host(ui-file-manager-content) {\n    perspective: 1000;\n    display: block;\n    inline-size: stretch;\n    block-size: stretch;\n    overflow: auto;\n    scrollbar-width: none;\n    scrollbar-color: transparent transparent;\n    scrollbar-gutter: auto;\n    grid-column: 1/-1;\n    z-index: 1;\n    position: relative;\n    contain: none;\n    isolation: isolate;\n    container-type: size;\n    touch-action: manipulation;\n    pointer-events: auto;\n    border-radius: 0;\n    margin: 0;\n    background-color: var(--color-surface, light-dark(#f7f8fc, #1a1d24));\n    color: var(--color-on-surface, light-dark(#1a1c1f, #e8eaed));\n  }\n  :host(ui-file-manager-content) {\n    /* Grid with subgrid columns */\n  }\n  :host(ui-file-manager-content) .fm-grid {\n    display: grid;\n    grid-template-columns: [icon] minmax(0px, 2.5rem) [name] minmax(0px, 1fr) [size] minmax(4.5rem, 6rem) [date] minmax(0px, 7.5rem) [actions] minmax(6.75rem, max-content);\n    grid-template-rows: auto minmax(0, 1fr);\n    row-gap: 0;\n    align-content: start;\n    inline-size: stretch;\n    min-block-size: 0;\n    block-size: 100%;\n    overflow: hidden;\n    scrollbar-width: none;\n    scrollbar-color: transparent transparent;\n    scrollbar-gutter: auto;\n    touch-action: manipulation;\n    pointer-events: none;\n  }\n  @container (inline-size <= 600px) {\n    :host(ui-file-manager-content) .fm-grid {\n      grid-template-columns: [icon] minmax(0px, 2.5rem) [name] minmax(0px, 1fr) [size] minmax(4.5rem, 6rem) [date] minmax(0px, 0px) [actions] minmax(6.75rem, max-content);\n    }\n  }\n  :host(ui-file-manager-content) .fm-grid-rows {\n    display: grid;\n    grid-template-columns: subgrid;\n    grid-auto-rows: 2.625rem;\n    grid-column: 1/-1;\n    align-content: start;\n    gap: 0.25rem;\n    overflow: auto;\n    scrollbar-gutter: stable;\n    min-block-size: 0;\n    scrollbar-width: thin;\n    scrollbar-color: color-mix(in oklab, var(--color-on-surface) 22%, transparent) transparent;\n    inline-size: stretch;\n    block-size: stretch;\n    z-index: 1;\n    /* WHY: Match host — avoid blank grid rows under transformed DWM / floating window ancestors. */\n    content-visibility: visible;\n    contain-intrinsic-size: 1px 2.625rem;\n    contain: strict;\n    touch-action: manipulation;\n    pointer-events: auto;\n  }\n  :host(ui-file-manager-content) .fm-grid-rows slot {\n    display: contents !important;\n  }\n  :host(ui-file-manager-content) :where(.row) {\n    background-color: color-mix(in oklab, var(--color-on-surface, #fff) 3%, transparent);\n    color: var(--color-on-surface);\n    display: grid;\n    grid-template-rows: minmax(0, 2.625rem) !important;\n    grid-column: 1/-1;\n    order: var(--order, 1) !important;\n    min-block-size: 0;\n    inline-size: stretch;\n    place-content: center;\n    place-items: center;\n    place-self: stretch;\n    justify-items: start;\n    padding: 0 0.65rem;\n    border-radius: 0.625rem;\n    border: none;\n    cursor: pointer;\n    pointer-events: auto;\n    touch-action: manipulation;\n    block-size: 2.625rem;\n    user-drag: none;\n    -webkit-user-drag: none;\n    text-align: start;\n    text-wrap: nowrap;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    letter-spacing: normal;\n    overflow: hidden;\n    gap: 0.35rem;\n    flex-wrap: nowrap;\n  }\n  @media (hover: hover) and (pointer: fine) {\n    :host(ui-file-manager-content) :where(.row) {\n      user-drag: element;\n      -webkit-user-drag: element;\n    }\n  }\n  :host(ui-file-manager-content) :where(.row) ui-icon {\n    inline-size: 1.25rem;\n    block-size: 1.25rem;\n    flex-shrink: 0;\n    place-content: center;\n    place-items: center;\n  }\n  :host(ui-file-manager-content) :where(.row) a, :host(ui-file-manager-content) :where(.row) span {\n    background-color: transparent !important;\n  }\n  :host(ui-file-manager-content) :where(.row) > * {\n    background-color: transparent !important;\n    min-block-size: 0;\n    block-size: auto;\n  }\n  :host(ui-file-manager-content) .row:hover {\n    background-color: color-mix(in oklab, var(--color-on-surface) 8%, transparent);\n  }\n  :host(ui-file-manager-content) .row:active {\n    background-color: color-mix(in oklab, var(--color-on-surface) 11%, transparent);\n  }\n  :host(ui-file-manager-content) .row:focus-visible {\n    outline: 2px solid var(--color-primary, #3794ff);\n    outline-offset: -2px;\n  }\n  :host(ui-file-manager-content) .c {\n    min-inline-size: 0;\n    display: flex;\n    flex-direction: row;\n    text-align: start;\n    text-wrap: nowrap;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    overflow: hidden;\n    inline-size: auto;\n    place-content: center;\n    place-items: center;\n    justify-content: start;\n    color: inherit;\n    min-block-size: 0;\n    block-size: auto;\n  }\n  :host(ui-file-manager-content) .icon {\n    grid-column: icon;\n    place-content: center;\n    place-items: center;\n  }\n  :host(ui-file-manager-content) .name {\n    grid-column: name;\n    inline-size: stretch;\n  }\n  :host(ui-file-manager-content) .size {\n    grid-column: size;\n    justify-content: end;\n    text-align: end;\n  }\n  :host(ui-file-manager-content) .date {\n    grid-column: date;\n    justify-content: end;\n    text-align: end;\n  }\n  :host(ui-file-manager-content) .actions {\n    grid-column: actions;\n  }\n  :host(ui-file-manager-content) .row, :host(ui-file-manager-content) ::slotted(.row), :host(ui-file-manager-content) .fm-grid, :host(ui-file-manager-content) .fm-grid-header {\n    grid-template-columns: [icon] minmax(0px, 2.5rem) [name] minmax(0px, 1fr) [size] minmax(4.5rem, 6rem) [date] minmax(0px, 7.5rem) [actions] minmax(6.75rem, max-content);\n  }\n  @container (inline-size <= 600px) {\n    :host(ui-file-manager-content) .row, :host(ui-file-manager-content) ::slotted(.row), :host(ui-file-manager-content) .fm-grid, :host(ui-file-manager-content) .fm-grid-header {\n      grid-template-columns: [icon] minmax(0px, 2.5rem) [name] minmax(0px, 1fr) [size] minmax(4.5rem, 6rem) [date] minmax(0px, 0px) [actions] minmax(6.75rem, max-content);\n    }\n    :host(ui-file-manager-content) .date {\n      display: none !important;\n    }\n  }\n  :host(ui-file-manager-content) .actions {\n    background-color: color-mix(in oklab, var(--color-on-surface, #fff) 5%, transparent);\n    color: var(--color-on-surface);\n    pointer-events: none;\n    padding: 0.2rem;\n    max-inline-size: stretch;\n    border-radius: 999px;\n    border: none;\n    display: flex;\n    flex-direction: row;\n    flex-wrap: nowrap;\n    place-content: center;\n    place-items: center;\n    place-self: center;\n    justify-content: flex-end;\n    justify-self: end;\n    inline-size: max-content;\n    block-size: 2.125rem;\n    gap: 0.15rem;\n    overflow: visible;\n  }\n  :host(ui-file-manager-content) .action-btn {\n    background-color: transparent;\n    color: var(--color-on-surface);\n    pointer-events: auto;\n    appearance: none;\n    border: none;\n    padding: 0;\n    border-radius: 999px;\n    cursor: pointer;\n    inline-size: 1.85rem;\n    block-size: 1.85rem;\n    min-inline-size: 1.85rem;\n    min-block-size: 1.85rem;\n    flex-shrink: 0;\n    aspect-ratio: 1;\n    display: inline-flex;\n    place-content: center;\n    place-items: center;\n    transition: background 0.14s ease, transform 0.1s ease;\n    position: relative;\n    overflow: hidden;\n    box-shadow: none;\n  }\n  :host(ui-file-manager-content) .action-btn:hover {\n    background-color: color-mix(in oklab, var(--color-on-surface) 12%, transparent);\n  }\n  :host(ui-file-manager-content) .action-btn:active {\n    transform: scale(0.94);\n  }\n  :host(ui-file-manager-content) .action-btn:focus-visible {\n    outline: 2px solid color-mix(in oklab, var(--color-primary, #3794ff) 55%, transparent);\n    outline-offset: 1px;\n  }\n  :host(ui-file-manager-content) .action-btn ui-icon {\n    inline-size: 1.0625rem;\n    block-size: 1.0625rem;\n    min-inline-size: 1.0625rem;\n    min-block-size: 1.0625rem;\n  }\n  :host(ui-file-manager-content) .fm-grid-header {\n    position: sticky !important;\n    display: grid;\n    grid-column: 1/-1;\n    inset-block-start: 0;\n    z-index: 8;\n    padding: 0.4rem 0.65rem;\n    border-radius: 0;\n    border: none;\n    box-shadow: 0 1px 0 color-mix(in oklab, var(--color-on-surface, #fff) 6%, transparent);\n    background: color-mix(in oklab, var(--color-on-surface, #fff) 3.5%, transparent);\n    font-size: 0.6875rem;\n    font-weight: 600;\n    letter-spacing: 0.04em;\n    text-transform: uppercase;\n    color: var(--color-on-surface-variant);\n    opacity: 1;\n    gap: 0.35rem;\n    min-block-size: 2rem;\n    place-content: center;\n    place-items: center;\n    justify-content: start;\n    justify-items: start;\n    text-align: start;\n    touch-action: manipulation;\n    pointer-events: auto;\n  }\n  :host(ui-file-manager-content) .fm-grid-header > * {\n    inline-size: auto;\n  }\n  :host(ui-file-manager-content) .fm-grid-header .c {\n    font-weight: 600;\n  }\n  :host(ui-file-manager-content) .fm-grid-header .icon {\n    grid-column: icon;\n  }\n  :host(ui-file-manager-content) .fm-grid-header .name {\n    grid-column: name;\n    inline-size: stretch;\n  }\n  :host(ui-file-manager-content) .fm-grid-header .size {\n    grid-column: size;\n    justify-content: end;\n    text-align: end;\n  }\n  :host(ui-file-manager-content) .fm-grid-header .date {\n    grid-column: date;\n    justify-content: end;\n    text-align: end;\n  }\n  :host(ui-file-manager-content) .fm-grid-header .actions {\n    grid-column: actions;\n    inline-size: stretch;\n    block-size: fit-content;\n    box-shadow: none;\n    padding: 0;\n    max-inline-size: stretch;\n    border-radius: 0;\n    display: flex;\n    flex-direction: row;\n    flex-wrap: nowrap;\n    place-content: center;\n    place-items: center;\n    text-wrap: nowrap;\n    text-overflow: ellipsis;\n    white-space: nowrap;\n    overflow: hidden;\n    gap: 0.25rem;\n    justify-content: flex-end;\n    justify-items: end;\n    justify-self: end;\n    text-align: end;\n  }\n}", ke = /* @__PURE__ */ new WeakMap(), R = () => new Promise((e) => {
...
}, H = (e) => V(e).startsWith(z), U = (e) => V(e) === "/", W = (e) => H(e) || U(e), Me = (e) => V(e).startsWith("/assets/icons/"), G = (e) => se(V(e)), Ne = (e) => {
	let t = V(e), n = /* @__PURE__ */ new Set();
	if (!Me(t)) return [];
	n.add("/assets/icons/"), n.add("/assets/icons/phosphor/"), n.add("/assets/icons/duotone/");
	for (let e of B) n.add(`/assets/icons/phosphor/${e}/`), n.add(`/assets/icons/${e}/`);
	let r = (e) => {
		for (let t of je) n.add(`${e}${t}.svg`);
	};
	if ((t === "/assets/icons/" || t === "/assets/icons/duotone/") && r("/assets/icons/duotone/"), t.startsWith("/assets/icons/phosphor/")) {
		...
		if (e.length >= 4) {
			let t = e[3];
			B.includes(t) && r(`/assets/icons/phosphor/${t}/`);
		}
	}
	...
	constructor() {
		this.#e = _([]), this.pathRef ??= _("/"), v(this.pathRef, (e) => {
			this.#l.value = W(e || "/"), this.loadPath(e || "/");
		}), navigator?.storage?.getDirectory?.()?.then?.((e) => {
			this.#r = e, this.refreshList(this.path || "/");
		});
	}
	async listAssetEntries(e) {
		let t = V(e), r = new Set(Ae);
		for (let e of Ne(t)) r.add(e);
		try {
		...
		let o = Array.from(i).sort((e, t) => e.localeCompare(t)).map((e) => h({
			name: e,
			kind: "directory"
	...
	async collectDirectoryEntries() {
		...
		return (await Promise.all((t || []).map(async (e) => Promise.try(async () => {
			let [t, r] = e;
			return ke?.getOrInsertComputed?.(r, async () => {
				let e = r?.kind || (t?.endsWith?.("/") ? "directory" : "file"), i = h({
					name: t,
					kind: e,
					handle: r
				});
	...
	async getDirectoryHandleByPath(e, t = !1) {
		...
		if (!n) return null;
		let r = V(e).split("/").filter(Boolean), i = n;
	...
	async readEntriesFromDirectory(e) {
		...
		for await (let [r, i] of e.entries()) {
			let e = i?.kind || (r?.endsWith?.("/") ? "directory" : "file"), a = h({
				name: r,
				kind: e,
				handle: i
			});
	...
	async listUserEntriesDirect(e, t = !1) {
		let n = V(e), r = n.replace(/^\/user\/?/, "/"), i = n, a = [], o = (e) => {
	...
	async itemAction(e) {
		...
		if (this.host?.dispatchEvent(r), !r.defaultPrevented) if (e?.kind === "directory") t.path = (t.path?.endsWith?.("/") ? t.path : t.path + "/") + e?.name + "/";
			...
			let r = (t.path || "/") + (e?.name || "");
			!e?.file && H(r) && (e.file = await o(r).catch(() => null), e.file && (e.size = e.file.size, e.lastModified = e.file.lastModified, e.type = e.file.type || e.type));
	...
	async loadPath(t = this.path) {
		...
		try {
			...
			let n = V(t?.value || t || this.path || "/");
			if (this.detachDirectoryObservers(), U(n)) return this.applyEntries(this.listVirtualRootEntries()), this;
			if (H(n)) return this.applyEntries(await this.listAssetEntries(n)), this;
			if (G(n)) {
			...
			await r()?.catch?.(console.warn.bind(console)), this.#s = v(await this.#i?.getMap?.() ?? [], () => {
		...
		try {
			...
			switch (t) {
				...
				case "movePath":
					...
					if (t === "delete") {
						G(r) ? await this.removeUserEntry(r, !0) : await c(this.#r, r), await this.refreshList(this.path);
						break;
					}
					if (t === "rename") {
						if (e?.kind === "file") {
							let e = prompt("Rename to:", n);
							e && e !== n && (G(r) ? await this.renameUserFile(r ?? "", e ?? "") : await this.renameFile(r ?? "", e ?? ""), await this.refreshList(this.path));
						}
						break;
					}
					break;
				...
				case "download":
					Promise.try(async () => {
						...
						e?.kind === "file" ? await m(await y(this.#r, r, { create: !1 })) : await m(await te(this.#r, r, { create: !1 }));
					}).catch(console.warn);
					break;
				case "copyPath":
					this.#o = {
					...
					try {
						await R(), await navigator.clipboard?.writeText?.(r);
					} catch {}
					break;
				case "copy":
					this.#o = {
	...
	async renameFile(e, t) {
		let n = await (await y(this.#r, e, { create: !1 }))?.getFile?.();
		n && (await y(this.#r, t, { create: !0 }).catch(() => null), await oe(this.#r, this.path + t, n), await c(this.#r, this.path + e));
	}
	async requestUpload() {
		if (!(this.readonly || W(this.path))) try {
	...
	async requestPaste() {
		if (!(this.readonly || W(this.path))) try {
			...
			let e = "";
			try {
				await R(), e = await navigator.clipboard?.readText?.();
			} catch {}
			let t = this.#o?.items || [];
			if (e) {
			...
			if (t.length > 0) {
				let e = t.join("\n");
				if (G(this.path) && t.every((e) => String(e || "").startsWith("/user/"))) {
					for (let e of t) {
		...
		if (!(this.readonly || W(this.path))) {
			if (e.preventDefault(), e.clipboardData || e.dataTransfer) {
				Promise.try(async () => {
					...
					if (n.length > 0 && G(this.path)) for (let e of n) await this.writeUserFile(e, this.path);
	...
	onCopy(e) {}
	async onDrop(e) {
		if (!(this.readonly || W(this.path)) && (e.preventDefault(), e.clipboardData || e.dataTransfer)) {
			let t = e.clipboardData || e.dataTransfer, n = await this.extractFilesFromData(t);
			if (n.length > 0 && G(this.path)) for (let e of n) await this.writeUserFile(e, this.path);
			else await i(t, this.path || "/");
			await this.refreshList(this.path);
...
}, K = (e, t = "file") => e ? e.startsWith("image/") ? "image" : e.startsWith("audio/") ? "music" : e.startsWith("video/") ? "video" : e === "application/pdf" ? "file-text" : e.includes("zip") || e.includes("7z") || e.includes("rar") ? "file-archive" : e.includes("json") ? "brackets-curly" : e.includes("csv") ? "file-spreadsheet" : e.includes("xml") ? "code" : e.startsWith("text/") ? "file-text" : t : t, Fe = {
	md: "file-text",
	txt: "file-text",
	pdf: "file-pdf",
	doc: "file-doc",
	...
	mov: "file-video",
	webm: "file-video"
}, Ie = (e) => Fe[e.split(".").pop()?.toLowerCase() || ""] || "file", Le = (e, t) => typeof e == "string" ? e === "directory" ? "folder" : K(t || e || "") : e?.kind === "directory" ? "folder" : K(e?.type) || Ie(e?.name || ""), q = /* @__PURE__ */ new Map(), Re = (e) => {
	if (e == null) return "";
...
var ze = d(Oe), J = class extends L {
	...
	bindDropHandlers() {
		let e = this;
		e && (t(e, "dragover", (e) => {
			g(e?.target, "ui-file-manager-content, ui-file-manager") && (e?.preventDefault?.(), e.dataTransfer && (e.dataTransfer.dropEffect = "copy"));
		}), t(e, "drop", (e) => {
			g(e?.target, "ui-file-manager-content, ui-file-manager") && (e?.preventDefault?.(), e?.stopPropagation?.(), this.operativeInstance?.onDrop?.(e));
		}));
	}
	onPaste(e) {
		g(e?.target, "ui-file-manager-content, ui-file-manager") && this.operativeInstance && this.operativeInstance.onPaste(e);
	}
	onCopy(e) {
		g(e?.target, "ui-file-manager-content, ui-file-manager") && this.operativeInstance && this.operativeInstance.onCopy(e);
	}
	byFirstTwoLetterOrName(e) {
		return ((e?.substring?.(0, 2)?.toUpperCase?.())?.charCodeAt?.(0) || 65) - 65;
	}
	constructor() {
		super(), this.operativeInstance ??= new Pe(), this.operativeInstance.host = this, this.addEventListener("entries-updated", () => this.syncRows()), this.refreshList();
	}
	syncRows() {
		let e = this.#e;
	...
	makeListElement(e, t) {
		let n = t, r = e?.kind === "file" || e?.file, i = f`<div draggable="${r}" class="row c2-surface"
            ...
            data-id=${e?.name || ""}
        >
            <div style="pointer-events: none; background-color: transparent;" class="c icon"><ui-icon icon=${Le(e)} /></div>
            ...
            <div style="pointer-events: none; background-color: transparent;" class="c date">${r ? Re(e?.lastModified ?? 0) : ""}</div>
	...
	styles = () => ze;
	render = function() {
		let e = this, t = f`<div class="fm-grid-header">
		...
		if (!n) return "";
		let r = f`<div class="fm-grid-rows" style="will-change: contents;"></div>`;
		return this.#e = r, _e?.(r, n.onMenuAction.bind(n), e.entries), queueMicrotask(() => {
			e.bindDropHandlers();
...
var Be = J, Ve = d("@charset \"UTF-8\";\n/* ai-refactor: optimized/refactored at 2026-02-13T00:45:15Z */\n/* ai-refactor: optimized/refactored at 2026-02-13T00:45:12Z */\n@layer tokens, base, layout, utilities, shells, shell, views, view, viewer, components, ux-layer, markdown, essentials, print, print-breaks, overrides;\n@layer components {\n  button,\n  .btn {\n    display: inline-flex;\n    align-items: center;\n    justify-content: center;\n    gap: var(--space-sm);\n    padding-block: 0px;\n    padding-inline: 0px;\n    font-size: var(--font-size-sm);\n    font-weight: 500;\n    border-radius: var(--radius-md);\n    background: var(--color-bg-alt);\n    color: var(--color-fg);\n    border: 1px solid var(--color-border);\n    cursor: pointer;\n    transition: all var(--transition-fast);\n  }\n  button:hover:not(:disabled),\n  .btn:hover:not(:disabled) {\n    background: var(--color-border);\n  }\n  button:focus-visible,\n  .btn:focus-visible {\n    outline: 2px solid var(--color-primary);\n    outline-offset: 2px;\n  }\n  button:disabled,\n  .btn:disabled {\n    opacity: 0.5;\n    cursor: not-allowed;\n  }\n  .btn {\n    --ui-bg: var(--color-surface-container-high);\n    --ui-fg: var(--color-on-surface);\n    --ui-bg-hover: var(--color-surface-container-highest);\n    --ui-ring: var(--color-primary);\n    --ui-radius: var(--radius-lg);\n    --ui-pad-y: var(--space-sm);\n    --ui-pad-x: var(--space-lg);\n    --ui-font-size: var(--text-sm);\n    --ui-font-weight: var(--font-weight-semibold);\n    --ui-min-h: 40px;\n    --ui-opacity: 1;\n    appearance: none;\n    border: none;\n    background: var(--ui-bg);\n    color: var(--ui-fg);\n    border-radius: var(--ui-radius);\n    padding: max(var(--ui-pad-y, 0px), 0px) max(var(--ui-pad-x, 0px), 0px);\n    font-size: var(--ui-font-size);\n    font-weight: var(--ui-font-weight);\n    letter-spacing: 0.01em;\n    line-height: 1.2;\n    block-size: calc-size(fit-content, max(var(--ui-min-h), size));\n    transition: background-color var(--motion-fast), box-shadow var(--motion-fast), transform var(--motion-fast);\n    box-shadow: var(--elev-0);\n    user-select: none;\n    touch-action: manipulation;\n    pointer-events: auto;\n    gap: var(--space-xs);\n    text-transform: none;\n    opacity: var(--ui-opacity);\n    min-block-size: fit-content;\n    min-inline-size: calc-size(fit-content, size + 0.5rem + var(--icon-size, 1rem));\n    max-inline-size: none;\n    max-block-size: stretch;\n    flex-direction: row;\n    flex-wrap: nowrap;\n    text-wrap: nowrap;\n    text-overflow: ellipsis;\n    overflow: hidden;\n    white-space: nowrap;\n    text-align: center;\n    text-decoration: none;\n    text-shadow: none;\n    text-rendering: auto;\n    contain: none;\n    container-type: normal;\n    place-items: center;\n    place-content: center;\n    justify-content: safe center;\n    justify-items: safe center;\n    align-content: safe center;\n    align-items: safe center;\n  }\n  .btn > ui-icon {\n    flex-shrink: 0;\n    pointer-events: none;\n    color: inherit;\n    align-self: center;\n    vertical-align: middle;\n  }\n  @media (max-width: 480px) {\n    .btn.btn-icon {\n      font-size: 0px !important;\n      aspect-ratio: 1/1;\n      block-size: fit-content;\n      max-block-size: stretch;\n      min-inline-size: 0px;\n      max-inline-size: fit-content;\n      gap: 0px;\n    }\n    .btn.btn-icon .btn-text,\n    .btn.btn-icon span:not(.sr-only) {\n      display: none !important;\n    }\n  }\n  .btn:hover {\n    background: var(--ui-bg-hover);\n    box-shadow: var(--elev-1);\n    transform: translateY(-1px);\n  }\n  .btn:active {\n    transform: translateY(0);\n    box-shadow: var(--elev-0);\n  }\n  .btn:focus-visible {\n    outline: none;\n    box-shadow: 0 0 0 3px color-mix(in oklab, var(--ui-ring) 35%, transparent);\n  }\n  .btn:disabled {\n    opacity: 0.5;\n    cursor: not-allowed;\n    transform: none !important;\n  }\n  .btn:disabled:hover {\n    background: var(--color-surface-container-high);\n    box-shadow: var(--elev-0);\n  }\n  .btn.primary, .btn.active {\n    --ui-bg: var(--color-primary);\n    --ui-fg: var(--color-on-primary);\n    --ui-ring: var(--color-primary);\n  }\n  .btn.primary {\n    --ui-bg-hover: color-mix(in oklab, var(--color-primary) 90%, black);\n  }\n  .btn.active {\n    box-shadow: var(--elev-1);\n  }\n  .btn.small {\n    --ui-pad-y: var(--space-xs);\n    --ui-pad-x: var(--space-md);\n    --ui-font-size: var(--text-xs);\n    --ui-min-h: 32px;\n    --ui-radius: var(--radius-md);\n  }\n  .btn.icon-btn {\n    inline-size: 40px;\n    block-size: 40px;\n    --ui-pad-y: 0px;\n    --ui-pad-x: 0px;\n    --ui-radius: 9999px;\n    --ui-font-size: var(--text-lg);\n  }\n  .btn[data-action=open-md], .btn[data-action=export-md], .btn[data-action=export-docx] {\n    --ui-font-size: 12px;\n    --ui-pad-x: 8px;\n    --ui-pad-y: 0px;\n    --ui-min-h: 28px;\n  }\n  .btn:is([data-action=view-markdown-viewer],\n  [data-action=view-markdown-editor],\n  [data-action=view-rich-editor],\n  [data-action=view-settings],\n  [data-action=view-history],\n  [data-action=view-workcenter]) {\n    --ui-font-size: 13px;\n    --ui-font-weight: 500;\n    --ui-pad-x: 12px;\n    --ui-pad-y: 0px;\n    --ui-min-h: 32px;\n    --ui-radius: 16px;\n    text-transform: capitalize;\n  }\n  .btn:is([data-action=view-markdown-viewer],\n  [data-action=view-markdown-editor],\n  [data-action=view-rich-editor],\n  [data-action=view-settings],\n  [data-action=view-history],\n  [data-action=view-workcenter][data-current],\n  [data-action=view-workcenter].active) {\n    --ui-bg: var(--color-surface-container-highest);\n    --ui-fg: var(--color-primary);\n    --ui-ring: var(--color-primary);\n  }\n  .btn:is([data-action=toggle-edit],\n  [data-action=snip],\n  [data-action=solve],\n  [data-action=code],\n  [data-action=css],\n  [data-action=voice],\n  [data-action=edit-templates],\n  [data-action=recognize],\n  [data-action=analyze],\n  [data-action=select-files],\n  [data-action=clear-prompt],\n  [data-action=view-full-history]) {\n    --ui-font-size: 12px;\n    --ui-pad-x: 8px;\n    --ui-pad-y: 0px;\n    --ui-min-h: 28px;\n    --ui-radius: 14px;\n  }\n  .btn:has(> ui-icon):not(:has(> *:not(ui-icon))), .btn:has(> span:only-of-type:empty) {\n    font-size: 0px !important;\n    aspect-ratio: 1/1;\n    block-size: fit-content;\n    max-block-size: stretch;\n    min-inline-size: 0px;\n    max-inline-size: fit-content;\n    gap: 0px;\n    overflow: visible;\n  }\n  .btn:has(> ui-icon):not(:has(> *:not(ui-icon))) span:not(.sr-only), .btn:has(> span:only-of-type:empty) span:not(.sr-only) {\n    display: none !important;\n  }\n  .btn-primary {\n    background: var(--color-primary);\n    color: white;\n    border-color: var(--color-primary);\n  }\n  .btn-primary:hover:not(:disabled) {\n    background: var(--color-primary-hover);\n    border-color: var(--color-primary-hover);\n  }\n  @media (max-inline-size: 768px) {\n    .btn {\n      --ui-pad-y: var(--space-xs);\n      --ui-pad-x: var(--space-md);\n      --ui-font-size: var(--text-xs);\n      --ui-min-h: 36px;\n    }\n  }\n  @media (max-inline-size: 480px) {\n    .btn {\n      --ui-pad-y: var(--space-xs);\n      --ui-pad-x: var(--space-xs);\n      --ui-font-size: var(--text-xs);\n      --ui-min-h: 32px;\n      white-space: nowrap;\n      overflow: hidden;\n      text-overflow: ellipsis;\n    }\n    .btn.btn-icon {\n      overflow: visible;\n    }\n  }\n  @media (prefers-reduced-motion: reduce) {\n    .btn {\n      transition: none;\n      transform: none !important;\n    }\n    .btn:hover, .btn:active {\n      transform: none !important;\n    }\n  }\n}\n@layer utilities {\n  .round-decor {\n    --background-tone-shift: 0;\n    padding-block: 0.25rem;\n    border-radius: 0.25rem;\n    overflow: hidden;\n  }\n  .round-decor:empty {\n    padding: 0;\n    display: none;\n    pointer-events: none;\n    visibility: collapse;\n  }\n  .time-format {\n    display: inline-flex;\n    flex-direction: row;\n    place-content: center;\n    place-items: center;\n    place-self: center;\n    padding: 0.125rem;\n    font: 500 0.9em \"InterVariable\", \"Inter\", \"Fira Mono\", \"Menlo\", \"Consolas\", monospace;\n    font-optical-sizing: auto;\n    font-variant-numeric: tabular-nums;\n    font-kerning: auto;\n    font-stretch: condensed;\n    font-width: condensed;\n    letter-spacing: -0.05em;\n    text-wrap: nowrap;\n    text-align: center;\n    white-space: nowrap;\n    text-overflow: ellipsis;\n  }\n  /*\n   * WHY: Launcher captions (`[data-layer=\"labels\"]`) must not inherit `aspect-ratio: 1/1` on the text span — it squares the pill height to the caption width.\n   */\n  .ui-ws-item:not([data-layer=labels]) span {\n    pointer-events: none;\n    aspect-ratio: 1/1;\n    inline-size: fit-content;\n    block-size: fit-content;\n    display: inline;\n  }\n  .ui-ws-item {\n    cursor: pointer;\n    user-select: none;\n    pointer-events: auto;\n  }\n  .ui-ws-item:active, .ui-ws-item:has(:active) {\n    will-change: inset, translate, transform, opacity, z-index;\n    cursor: grabbing;\n  }\n}\n@layer essentials {\n  @media print {\n    .ctx-menu, .ux-anchor, .component-loading, .component-error {\n      display: none !important;\n      visibility: hidden !important;\n      opacity: 0 !important;\n      pointer-events: none !important;\n      position: absolute !important;\n      inset: 0 !important;\n      z-index: -1 !important;\n      inline-size: 0 !important;\n      block-size: 0 !important;\n      max-inline-size: 0 !important;\n      max-block-size: 0 !important;\n      min-inline-size: 0 !important;\n      min-block-size: 0 !important;\n      margin: 0 !important;\n      padding: 0 !important;\n      border: none !important;\n      overflow: hidden !important;\n    }\n  }\n  @media screen {\n    :root, :host, :scope {\n      --font-family: \"InterVariable\", \"Inter\", \"Helvetica Neue\", \"Helvetica\", \"Calibri\", \"Roboto\", ui-sans-serif, system-ui, -apple-system, Segoe UI, sans-serif;\n    }\n    ui-window-frame,\n    ui-modal,\n    .ui-grid-item {\n      --opacity: 1;\n      --scale: 1;\n      --rotate: 0deg;\n      --translate-x: 0%;\n      --translate-y: 0%;\n      isolation: isolate;\n      content-visibility: auto;\n      transform-origin: 50% 50%;\n      transform-style: flat;\n      transform-box: fill-box;\n      translate: 0% 0% 0%;\n      opacity: var(--opacity, 1);\n      rotate: 0deg;\n      scale: 1;\n    }\n    .ctx-menu {\n      --font-family: \"InterVariable\", \"Inter\", \"Helvetica Neue\", \"Helvetica\", \"Calibri\", \"Roboto\", ui-sans-serif, system-ui, -apple-system, Segoe UI, sans-serif;\n      /*\n       * WHY: Menus are appended to `body` / overlay, outside `.view-explorer`, so app color\n       * tokens are often missing — without fallbacks text can match background (dark on dark).\n       */\n      color-scheme: light dark;\n    }\n    .ctx-menu,\n    .ctx-menu * {\n      visibility: visible;\n      content-visibility: visible;\n    }\n    .ctx-menu {\n      position: fixed;\n      z-index: 99999;\n      inline-size: max-content;\n      min-inline-size: 160px;\n      max-inline-size: min(240px, 100cqi);\n      block-size: fit-content;\n      padding: 0.25rem 0;\n      border: 1px solid var(--color-outline-variant, light-dark(#c9ced8, #474e5e));\n      border-radius: var(--radius-md, 10px);\n      background-color: var(--color-surface, light-dark(#f6f8fc, #1b2029));\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n      font-size: 0.875rem;\n      font-weight: 400;\n      box-shadow: 0 10px 28px light-dark(rgba(15, 23, 42, 0.14), rgba(0, 0, 0, 0.42)), 0 0 0 1px light-dark(rgba(15, 23, 42, 0.08), rgba(255, 255, 255, 0.07));\n      opacity: 1;\n      visibility: visible;\n      pointer-events: auto;\n      transform: scale3d(var(--scale, 1), var(--scale, 1), 1) translate3d(var(--translate-x, 0px), var(--translate-y, 0px), 0px);\n      transition: opacity 0.15s ease-out, visibility 0.15s ease-out, transform 0.15s ease-out;\n      font-family: var(--font-family, 'system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif') !important;\n      text-align: start;\n      display: flex;\n      flex-direction: column;\n      align-items: stretch;\n    }\n    .ctx-menu[data-hidden] {\n      opacity: 0;\n      visibility: hidden;\n      pointer-events: none;\n    }\n    .ctx-menu > * {\n      display: flex;\n      flex-direction: row;\n      align-items: center;\n      justify-content: flex-start;\n      text-align: start;\n      inline-size: stretch;\n      min-block-size: 2rem;\n      gap: 0.5rem;\n      padding: 0.375rem 0.75rem;\n      border: none;\n      border-radius: var(--radius-sm, 8px);\n      outline: none;\n      position: relative;\n      background-color: transparent;\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n      cursor: pointer;\n      text-wrap: nowrap;\n      text-overflow: ellipsis;\n      white-space: nowrap;\n      overflow: hidden;\n      pointer-events: auto;\n      transition: background-color 0.15s ease, color 0.15s ease;\n      font-family: var(--font-family, 'system-ui, -apple-system, BlinkMacSystemFont, \"Segoe UI\", Roboto, sans-serif') !important;\n    }\n    .ctx-menu > *:hover {\n      background-color: var(--color-surface-container-high, light-dark(#e8ecf4, #2a3140));\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n    }\n    .ctx-menu > *:active {\n      background-color: var(--color-surface-container-highest, light-dark(#dde3ee, #343b4d));\n      color: var(--color-on-surface, light-dark(#12151c, #eceff7));\n    }\n    .ctx-menu > *:focus-visible {\n      outline: 2px solid var(--color-primary, light-dark(#1d6fd1, #7eb8ff));\n      outline-offset: 1px;\n      background-color: var(--color-surface-container-high, light-dark(#e8ecf4, #2a3140));\n    }\n    .ctx-menu > *:not(.ctx-menu-separator) {\n      gap: 0.5rem;\n    }\n    .ctx-menu > * > * {\n      pointer-events: none;\n    }\n    .ctx-menu > * > span {\n      flex: 1 1 auto;\n      min-inline-size: 0;\n      text-align: start !important;\n      user-select: none;\n      pointer-events: none;\n      font-size: 0.875rem;\n      font-weight: 400;\n      line-height: 1.25;\n      color: inherit;\n    }\n    .ctx-menu > * > ui-icon {\n      --icon-size: 1rem;\n      flex-shrink: 0;\n      inline-size: var(--icon-size);\n      block-size: var(--icon-size);\n      color: var(--color-on-surface-variant, light-dark(#545c6f, #b4bfd4));\n      user-select: none;\n      pointer-events: none;\n    }\n    .ctx-menu > .ctx-menu-separator, .ctx-menu.ctx-menu-separator {\n      min-block-size: auto;\n      block-size: 1px;\n      margin: 0.125rem 0.375rem;\n      padding: 0;\n      background-color: var(--color-outline-variant, light-dark(#c9ced8, #474e5e));\n      opacity: 0.55;\n      pointer-events: none;\n    }\n    .ctx-menu {\n      /*\n       * `.grid-rows` applies subgrid + place(center) to children, which centers\n       * label text per row. Context menus must stay flex rows with start-aligned labels.\n       */\n    }\n    .ctx-menu.grid-rows {\n      display: flex !important;\n      flex-direction: column;\n      align-items: stretch;\n      grid-template-columns: unset !important;\n      grid-auto-rows: unset !important;\n    }\n    .ctx-menu.grid-rows > *:not(.ctx-menu-separator) {\n      display: flex !important;\n      flex-flow: row nowrap !important;\n      align-items: center !important;\n      justify-content: flex-start !important;\n      grid-column: unset !important;\n      grid-row: unset !important;\n      grid-template-columns: unset !important;\n      grid-template-rows: unset !important;\n      place-content: unset !important;\n      place-items: unset !important;\n    }\n    .ux-anchor {\n      --shift-x: var(--client-x, 0px);\n      --shift-y: var(--client-y, 0px);\n      --translate-x: round(nearest, min(0px, calc(100cqi - (100% + var(--shift-x, 0px)))), calc(1px / var(--pixel-ratio, 1))) !important;\n      --translate-y: round(nearest, min(0px, calc(100cqb - (100% + var(--shift-y, 0px)))), calc(1px / var(--pixel-ratio, 1))) !important;\n      inset-inline-start: max(var(--shift-x), 0px);\n      inset-block-start: max(var(--shift-y), var(--status-bar-padding, 0px));\n      inset-inline-end: auto;\n      inset-block-end: auto;\n      direction: ltr;\n      writing-mode: horizontal-tb;\n      translate: 0% 0% 0%;\n      transform: none;\n    }\n    .component-loading,\n    .component-error {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      padding: 2rem;\n      gap: 1rem;\n      color: var(--text-secondary, light-dark(#666, #aaa));\n    }\n    .component-loading .loading-spinner {\n      inline-size: 2rem;\n      block-size: 2rem;\n      border: 2px solid var(--border, light-dark(#ddd, #444));\n      border-block-start: 2px solid var(--primary, light-dark(#007bff, #5fa8ff));\n      border-radius: 50%;\n      animation: spin 1s linear infinite;\n    }\n    .component-error {\n      text-align: center;\n    }\n    .component-error h3 {\n      margin: 0;\n      color: var(--error, light-dark(#dc3545, #ff6b6b));\n    }\n    .component-error p {\n      margin: 0;\n    }\n    ui-icon {\n      display: inline-flex;\n      align-items: center;\n      justify-content: center;\n      inline-size: var(--icon-size, 1.25rem);\n      block-size: var(--icon-size, 1.25rem);\n      min-inline-size: var(--icon-size, 1.25rem);\n      min-block-size: var(--icon-size, 1.25rem);\n      color: currentColor;\n      fill: currentColor;\n      flex-shrink: 0;\n      vertical-align: middle;\n      opacity: 1;\n      visibility: visible;\n      /* When a parent uses font-size: 0 for layout, keep raster/mask math stable */\n      font-size: 1rem;\n    }\n    ui-icon svg,\n    ui-icon img {\n      inline-size: 100%;\n      block-size: 100%;\n      color: inherit;\n      fill: currentColor;\n    }\n    :is(button, .btn) > ui-icon {\n      color: inherit;\n    }\n    .file-picker {\n      display: flex;\n      flex-direction: column;\n      align-items: center;\n      justify-content: center;\n      min-block-size: 300px;\n      padding: 2rem;\n      text-align: center;\n    }\n    .file-picker .file-picker-header {\n      margin-block-end: 2rem;\n    }\n    .file-picker .file-picker-header h2 {\n      margin: 0 0 0.5rem 0;\n      color: var(--color-on-surface);\n      font-size: 1.5rem;\n      font-weight: 600;\n    }\n    .file-picker .file-picker-header p {\n      margin: 0;\n      color: var(--color-on-surface-variant);\n      font-size: 0.9rem;\n    }\n    .file-picker .file-picker-actions {\n      display: flex;\n      flex-wrap: wrap;\n      justify-content: center;\n      gap: 1rem;\n      margin-block-end: 2rem;\n    }\n    .file-picker .file-picker-actions .btn {\n      display: flex;\n      align-items: center;\n      gap: 0.5rem;\n      padding: 0.75rem 1.5rem;\n      border: 1px solid transparent;\n      border-radius: var(--radius-md);\n      font-weight: 500;\n      transition: all 0.2s ease;\n    }\n    .file-picker .file-picker-actions .btn:hover {\n      transform: translateY(-1px);\n      box-shadow: 0 4px 8px rgba(0, 0, 0, 0.1);\n    }\n    .file-picker .file-picker-actions .btn.btn-primary {\n      background: var(--color-primary);\n      color: var(--color-on-primary);\n      border-color: var(--color-primary);\n    }\n    .file-picker .file-picker-actions .btn:not(.btn-primary) {\n      background: var(--color-surface-container);\n      color: var(--color-on-surface);\n      border-color: var(--color-outline-variant);\n    }\n    .file-picker .file-picker-info {\n      max-inline-size: 400px;\n    }\n    .file-picker .file-picker-info p {\n      margin: 0.25rem 0;\n      font-size: 0.85rem;\n      color: var(--color-on-surface-variant);\n    }\n    .file-picker .file-picker-info p strong {\n      color: var(--color-on-surface);\n    }\n  }\n}\n@layer ux-file-manager {\n  :host(ui-file-manager), :host(ui-file-manager) :where(*) {\n    box-sizing: border-box;\n    user-select: none;\n    -webkit-tap-highlight-color: transparent;\n  }\n  :host(ui-file-manager) {\n    perspective: 1000;\n    container-type: inline-size;\n    display: grid;\n    inline-size: stretch;\n    block-size: stretch;\n    min-block-size: 0;\n    min-inline-size: 0;\n    /* WHY: `content-visibility: auto` can skip painting when ancestors use transform/stacking\n     * (e.g. `.wf-frame-body { transform: translateZ(0) }`), so lists “vanish” in window frames. */\n    content-visibility: visible;\n    border-radius: 0;\n    overflow: hidden;\n    margin: 0;\n    line-height: normal;\n    max-block-size: none;\n    max-inline-size: none;\n    flex-grow: 1;\n    background-color: var(--color-surface, light-dark(#f7f8fc, #1a1d24));\n    color: var(--color-on-surface, light-dark(#1a1c1f, #e8eaed));\n  }\n  :host(ui-file-manager) .fm-root {\n    gap: 0;\n    display: grid;\n    grid-template-columns: [content-col] minmax(0px, 1fr);\n    grid-template-rows: auto minmax(0px, 1fr);\n    inline-size: stretch;\n    block-size: stretch;\n    min-block-size: 0;\n    overflow: hidden;\n  }\n  :host(ui-file-manager) .fm-toolbar {\n    grid-column: 1/-1;\n    display: grid;\n    grid-template-columns: minmax(0px, max-content) minmax(0px, 1fr) minmax(0px, max-content);\n    grid-template-rows: minmax(0px, 1fr);\n    grid-auto-flow: column;\n    place-content: center;\n    place-items: center;\n    gap: 0.625rem;\n    border-radius: 0;\n    padding: 0.5rem 0.75rem;\n    line-height: normal;\n    background: var(--color-surface, light-dark(#f7f8fc, #1a1d24));\n    box-shadow: 0 1px 0 color-mix(in oklab, var(--color-on-surface, #fff) 6%, transparent);\n  }\n  :host(ui-file-manager) .fm-toolbar button, :host(ui-file-manager) .fm-toolbar input {\n    background-color: transparent;\n    color: var(--color-on-surface);\n  }\n  :host(ui-file-manager) .fm-toolbar input {\n    inline-size: stretch;\n    block-size: stretch;\n    border: none;\n    outline: none;\n    padding: 0.45rem 0.85rem;\n    overflow: auto;\n    border-radius: 999px;\n    font: 0.8125rem/1.35 var(--explorer-font-mono, ui-monospace, \"Cascadia Code\", \"SF Mono\", Consolas, monospace);\n    background: color-mix(in oklab, var(--color-on-surface, #fff) 6%, transparent);\n  }\n  :host(ui-file-manager) .fm-toolbar input:focus-visible {\n    box-shadow: 0 0 0 2px color-mix(in oklab, var(--color-primary, #3794ff) 45%, transparent);\n  }\n  :host(ui-file-manager) .fm-toolbar .btn {\n    transition: background 0.14s ease, transform 0.1s ease;\n    appearance: none;\n    border: 0;\n    padding: 0;\n    border-radius: 999px;\n    cursor: pointer;\n    inline-size: 2.5rem;\n    block-size: 2.5rem;\n    aspect-ratio: 1/1;\n    display: inline-flex;\n    align-items: center;\n    justify-content: center;\n    background: transparent;\n  }\n  :host(ui-file-manager) .fm-toolbar .btn ui-icon {\n    inline-size: 1.25rem;\n    block-size: 1.25rem;\n    flex-shrink: 0;\n  }\n  :host(ui-file-manager) .fm-toolbar .btn:hover {\n    background: color-mix(in oklab, var(--color-on-surface) 9%, transparent);\n  }\n  :host(ui-file-manager) .fm-toolbar .btn:active {\n    transform: scale(0.96);\n  }\n  :host(ui-file-manager) .fm-toolbar .btn:focus-visible {\n    outline: 2px solid color-mix(in oklab, var(--color-primary, #3794ff) 55%, transparent);\n    outline-offset: 1px;\n  }\n  :host(ui-file-manager) .fm-toolbar > * {\n    display: flex;\n    flex-direction: row;\n    flex-wrap: nowrap;\n    gap: 0.2rem;\n    block-size: fit-content;\n    min-block-size: stretch;\n    align-items: center;\n  }\n  :host(ui-file-manager) .fm-toolbar .fm-toolbar-left {\n    grid-column: 1;\n  }\n  :host(ui-file-manager) .fm-toolbar .fm-toolbar-left, :host(ui-file-manager) .fm-toolbar .fm-toolbar-right {\n    padding: 0.2rem;\n    border-radius: 999px;\n    background: color-mix(in oklab, var(--color-on-surface, #fff) 5.5%, transparent);\n  }\n  :host(ui-file-manager) .fm-toolbar .fm-toolbar-center {\n    grid-column: 2;\n    flex-grow: 1;\n    inline-size: stretch;\n    block-size: fit-content;\n    min-block-size: 2.5rem;\n    border-radius: 999px;\n    padding: 0;\n    overflow: hidden;\n    place-content: stretch;\n    place-items: stretch;\n    justify-content: start;\n    background: color-mix(in oklab, var(--color-on-surface, #fff) 5.5%, transparent);\n  }\n  :host(ui-file-manager) .fm-toolbar .fm-toolbar-center > * {\n    inline-size: stretch;\n    block-size: stretch;\n  }\n  :host(ui-file-manager) .fm-toolbar .fm-toolbar-center input {\n    padding-inline: 0.9rem;\n    inline-size: stretch;\n    background: transparent;\n  }\n  :host(ui-file-manager) .fm-toolbar .fm-toolbar-right {\n    grid-column: 3;\n  }\n  :host(ui-file-manager) .fm-sidebar {\n    grid-row: 2;\n    grid-column: sidebar-col;\n    align-content: start;\n    gap: 0.5rem;\n    padding: 0.5rem;\n    border-radius: 0.5rem;\n    line-height: normal;\n    justify-content: start;\n    justify-items: start;\n    text-align: start;\n    display: none;\n  }\n  :host(ui-file-manager) .fm-sidebar .sec {\n    display: grid;\n    gap: 0.25rem;\n    place-content: start;\n    place-items: start;\n    justify-content: start;\n    justify-items: start;\n  }\n  :host(ui-file-manager) .fm-sidebar .sec-title {\n    font-weight: 600;\n    opacity: 0.8;\n    padding-block: 0.25rem;\n    place-self: start;\n  }\n  :host(ui-file-manager) .fm-sidebar .link {\n    text-align: start;\n    appearance: none;\n    border: 0;\n    padding: 0.25rem 0.375rem;\n    border-radius: 0.375rem;\n    cursor: pointer;\n    line-height: normal;\n  }\n  :host(ui-file-manager) .fm-content {\n    grid-row: 2;\n    grid-column: content-col;\n    inline-size: stretch;\n    block-size: stretch;\n    min-block-size: 0;\n    overflow: hidden;\n    border-radius: 0;\n    padding: 0 0.35rem 0.45rem;\n    scrollbar-width: thin;\n    scrollbar-color: color-mix(in oklab, var(--color-on-surface) 22%, transparent) transparent;\n  }\n  :host(ui-file-manager) .status {\n    padding: 0.5rem;\n    opacity: 0.8;\n  }\n  :host(ui-file-manager) .status.error {\n    color: var(--error-color, crimson);\n  }\n  @container (inline-size < 520px) {\n    :host(ui-file-manager) .fm-content {\n      grid-column: 1/-1;\n    }\n    :host(ui-file-manager) .fm-root {\n      grid-column: 1/-1;\n    }\n    :host(ui-file-manager) .fm-grid {\n      grid-column: 1/-1;\n    }\n    :host(ui-file-manager) .fm-root[data-with-sidebar=true] {\n      grid-template-columns: [content-col] minmax(0px, 1fr);\n    }\n    :host(ui-file-manager) .fm-sidebar {\n      display: none !important;\n    }\n  }\n}"), Y = class extends L {
	...
	onInitialize() {
		...
		return queueMicrotask(() => {
			this.#e?.(), this.#e = null, this.pathRef && (this.#e = v(this.pathRef, (e) => {
	...
	render = function() {
		let e = this, t = e.showSidebar, n = f`<div part="content" class="fm-content"><slot></slot></div>`;
		return f`<div part="root" class="fm-root" data-with-sidebar=${t}>${f`<div part="toolbar" class="fm-toolbar">
...
function Z(e) {
	if (!e) return;
	let t = e;
	return t.colorScheme ? t.colorScheme : X(t.params?.colorScheme ?? t.params?.theme);
}
function Q(e) {
	if (e != null) {
		if (typeof e == "string") return X(e.trim());
		if (typeof e == "object") {
			let t = e;
			return X(t.colorScheme ?? t.scheme ?? t.theme);
		}
	}
}
function Ue() {
...
var Ge = "cw-view-explorer", Ke = ce(Ge, (e) => class extends e {
	id = "explorer";
	name = "Explorer";
	icon = "folder";
	explorerRoot = null;
	...
	lifecycle = {
		...
		onShow: () => {
			this._sheet ??= ne(He), this.syncExplorerThemeSubscription(), !this.explorerCleanup && this.explorerRoot && this.attachExplorerWire();
		},
		onHide: () => {
	...
	constructor(e) {
		if (super(), e) {
			...
			let t = X(e.params?.colorScheme ?? e.params?.theme);
			!e.colorScheme && t && (this.options.colorScheme = t);
		}
	}
	setExplorerColorScheme(e) {
		this.options.colorScheme = e, F(this.explorerRoot, e), this.syncExplorerThemeSubscription();
	}
	syncExplorerThemeSubscription() {
		this.themeSync?.disconnect(), this.themeSync = null, this.explorerRoot && (this.themeSync = I(this.explorerRoot, () => this.options.colorScheme ?? "system"));
	}
	render = (e) => {
		if (e) {
			this.options = {
		...
		this.explorerCleanup && (this.themeSync?.disconnect(), this.themeSync = null, this.detachExplorerWire()), this.explorerRoot = customElements.get("ui-file-manager") ? Ue() : We();
		let t = Z(e) ?? Z(this.options);
		return F(this.explorerRoot, t ?? "system"), this.syncExplorerThemeSubscription(), this.explorerRoot;
	};
	getToolbar() {
		return null;
	}
	...
	async handleMessage(e) {
		let t = e;
		if (t.type === x.SetColorScheme) {
			let e = Q(t.data?.colorScheme ?? t.data?.scheme ?? t.data?.theme) ?? "system";
	...
	invokeChannelApi(e, t) {
		...
		switch (e) {
			case x.NavigatePath:
			case x.ContentExplorer:
			case x.Navigate: {
				let e = n();
				return e ? (this.navigateExplorer(e), !0) : !1;
			}
			case x.GetPath: return this.wiredFileManager?.path ?? null;
			case x.FileSave:
			case "file-save": {
			...
			case x.RequestUse: return this.wiredFileManager?.requestUse?.(), !0;
			case x.RequestUpload: return this.wiredFileManager?.requestUpload?.(), !0;
			case x.RequestPaste: return this.wiredFileManager?.requestPaste?.(), !0;
			...
			case "get-color-scheme": {
				let e = this.options;
				return e.colorScheme ?? Z(e) ?? "system";
			}
	...
	attachExplorerWire() {
		...
		let e = this.options, { cleanup: t, fileManager: n } = M(this.explorerRoot, {
...
//#endregion
export { Ke as CwViewExplorer, Y as FileManager, Be as FileManagerContent, Ge as TAG, F as applyExplorerColorScheme, $ as createExplorerView, $ as default, O as getRegisteredExplorerInject, E as mergeExplorerInject, N as readAppDataTheme, ye as registerExplorerInject, P as resolveExplorerColorSchemePreference, I as subscribeExplorerSystemTheme, M as wireExplorerSubtree };
