...
import type { AirPadReconnectAfterConfigOptions } from "./coordinator";
 ...
 */
export function reconnectAirPadSessionAfterConfigChange(options?: AirPadReconnectAfterConfigOptions): void {
